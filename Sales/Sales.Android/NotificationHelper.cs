    ...
    class NotificationHelper : INotification
    {
        ...
        public void CreateNotification(String title, String message)
        {
            try
            {
                ...
                var sound = global::Android.Net.Uri.Parse(ContentResolver.SchemeAndroidResource + "://" + mContext.PackageName + "/" + Resource.Drawable.sales);
                ...
                mBuilder.SetSmallIcon(Resource.Drawable.sales);
                mBuilder.SetContentTitle(title)
                        ...
                        .SetSmallIcon(Resource.Drawable.sales)
